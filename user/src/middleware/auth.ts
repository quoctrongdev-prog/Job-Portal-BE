...
//cung nhu them (tao) user vao req
...
Promise<void> => { 
    try {
        ...
        //Sql lay du lieu user tu 3 table users, user_skills va skills 
        //(left join 3 bang lai)
        ...
        //gan du lieu user tu db vao bien user
        ...
        //user la du lieu user tu db 
        //req co the cham den cac cot trong db tu user nay (3 tables join lai)
        req.user = user;
